...
add_action ( 'init', 'prowp_register_agenda_post_type');

function prowp_register_agenda_post_type() {
	$labels = array(
		'name' => __( 'Agenda' ),
		'singular_name' => __( 'Agenda' ),
		'add_new' => __( 'Añadir Agenda' ),
		'add_new_item' => __( 'Añadir Nueva Agenda' ),
		'edit' => __( 'Editar' ),
		'edit_item' => __( 'Editar Agenda' ),
		'new_item' => __( 'Nueva Agenda' ),
		'view' => __( 'Ver Agenda' ),
		'view_item' => __( 'Ver Agenda' ),
		'search_items' => __( 'Buscar Agenda' ),
		'not_found' => __( 'Agenda No Encontrada' ),
		'not_found_in_trash' => __( 'Agenda no encontrada en Papelera' )
	);
	register_post_type( 'agenda', //post type name
		array(
			'labels' => $labels,
			'has_archive' => true,
			'public' => true,
			'description' => __( 'Agenda' ),
			'supports' => array(
				'title',
				'editor',
				//'author',
