<?php
/**
 * Template Name: Plantilla Página Hijo Nosotros
 *
 * @package achee-theme
 */
...
<div class="imgBanner">
	...
	<div class="background parallax-window" data-parallax="scroll" style="" data-image-src="<?php echo get_template_directory_uri().'/img/img-nosotros.jpg' ?>" data-position-y="-200px"></div>
</div>
<div class="container">
	<div id="content-wrapper" class="row">
		...
		<div id="primary" class="content-area col s12 m12 l9">
			...
			<?php 
			/*div class="pages-rs">
				<?php //dynamic_sidebar( 'social-networks' ); ?>
			</div>*/
			?>
		</div><!-- #primary -->
