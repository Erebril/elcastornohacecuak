<?php
/**
 * Template Name: Plantilla Página Padre Asesoría
 *
 * @package achee-theme
 */
...
<div class="imgBanner">
	...
	<div class="background parallax-window" data-parallax="scroll" data-image-src="<?php echo get_template_directory_uri().'/img/img-asesoramiento.jpg' ?>" data-position-y="-70px"></div>
</div>
<div class="container">
