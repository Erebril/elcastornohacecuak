<?php
/**
 * Template Name: Plantilla Página Padre Eficiencia
 *
 * @package achee-theme
 */
...
<div class="imgBanner">
	...
	<div class="background parallax-window" data-parallax="scroll" data-image-src="<?php echo get_template_directory_uri().'/img/img-ee.jpg' ?>" data-position-y="8px"></div>
</div>
<div class="container">
